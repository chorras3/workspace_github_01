...
private static void test_002( ) {
	...
	////g = new DirectedSparseMultigraph<MyNode, MyLink>();
	Graph g3 = new DirectedSparseMultigraph<MyNode, MyLink_01>();
	...
	// Add some directed edges along with the vertices to the graph
	g3.addEdge(new MyLink_01(2.0, 48),n1, n2); // This method
	g3.addEdge(new MyLink_01(2.0, 48),n2, n3);
	g3.addEdge(new MyLink_01(3.0, 192), n3, n5);
	g3.addEdge(new MyLink_01(2.0, 48), n5, n4); // or we can use
	g3.addEdge(new MyLink_01(2.0, 48), n4, n2); // In a directed graph the
	g3.addEdge(new MyLink_01(2.0, 48), n3, n1); // first node is the source
	g3.addEdge(new MyLink_01(10.0, 48), n2, n5);// and the second the destination
	
	System.out.println("The graph g3 = " + g3.toString());
	
	
	DijkstraShortestPath<MyNode,MyLink_01> alg = new DijkstraShortestPath(g3);
	List<MyLink_01> l = alg.getPath(n1, n4);
