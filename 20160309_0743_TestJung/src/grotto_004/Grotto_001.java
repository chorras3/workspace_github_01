...
//		test_003();
	...
	private static void test_004() {

		/*
		 * 3.3 section of pdf ( 3.3 Max-Flows and the Factory Idiom )
		 */

		System.out.println("test_004(). start. ");
...
//				edgeFactory);		
	...
	private static void test_003() {
		/*
		 * 3.2 section of pdf ( 3.2 A Weighted Shortest Path and Transformer
		 * classes )
		 */
