package grotto_006_section4_included;
...
class Grotto_001_section4_included {
...
//	}
	private static void test_section_04_02() {
		...
		// Layout<V, E>, BasicVisualizationServer<V,E>
//		Layout<Integer, String> layout = new CircleLayout(sgv.g);
		////Layout<Integer, String> layout = new ForestTreeLayout(sgv.g);
		////Layout<Integer, String> layout = new TreeLayout<Integer, String>((Forest<Integer, String>) graph);
		////Layout<Integer, String> layout = new TreeLayout(null, 0, 0);
		Layout<Integer, String> layout = new TreeLayout((Forest) sgv, 1);
