...
@NamedQueries({
	@NamedQuery(name = FuncionSubRol_ORIG.QUERY_FUNCION_SUBROLES_POR_ROL, query = "select new com.SGPF.coopera2020.modelo.items.ItemGeneral(o.id.codFuncion,o.actuaOconsulta) from FuncionSubRol o where o.id.codRol = :"+Keys.COD_ROL),
	@NamedQuery(name = FuncionSubRol_ORIG.QUERY_FUNCION_PERMISO_ROL_SUBROL_FUNCION, query = "select o from FuncionSubRol o where o.id.codRol = :"+Keys.COD_ROL+" and o.id.codSubRol = :"+Keys.COD_SUB_ROL+" and o.id.codFuncion = :"+Keys.COD_FUNCION)
})
...
public class FuncionSubRol_ORIG implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FuncionSubRol_ORIG other = (FuncionSubRol_ORIG) obj;
	...
	public static final List<Orden> getOrdenPorDefecto(){
		...
		ordenacion.add(new Orden(FuncionSubRol_ORIG.COD_ROL,Orden.ORDEN_ASCENDENTE));
		ordenacion.add(new Orden(FuncionSubRol_ORIG.COD_SUB_ROL,Orden.ORDEN_ASCENDENTE));
		ordenacion.add(new Orden(FuncionSubRol_ORIG.COD_FUNCION,Orden.ORDEN_ASCENDENTE));
		ordenacion.add(new Orden(FuncionSubRol_ORIG.FASE_VALIDACION,Orden.ORDEN_ASCENDENTE));		
        return ordenacion;	
	}
